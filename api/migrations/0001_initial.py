    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(default='users_photo/default.jpg', upload_to='users_photo/')),
                ('phone_number', models.CharField(blank=True, max_length=13, null=True, unique=True)),
                ('location', models.CharField(choices=[('kokand', 'kokand'), ('ferghana', 'ferghana'), ('andijan', 'andijan')], max_length=20)),
